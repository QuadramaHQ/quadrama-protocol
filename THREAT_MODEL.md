...
The relay server is treated as **untrusted** at all times.
...
If a peer’s identity keys change, verification is **automatically invalidated**.
...
*This threat model reflects the public design assumptions. It is not a formal security proof.*
